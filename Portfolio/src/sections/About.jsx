...
const About = () => {
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText(' ubaidahmad2468@gmail.com');
    setHasCopied(true);
      ...
      <div className="grid xl:grid-cols-3 xl:grid-rows-6 md:grid-cols-2 grid-cols-1 gap-5 h-full">
        <div className="col-span-1 xl:row-span-3">
          <div className="grid-container">
            ...
            <div>
              <p className="grid-headtext">Hi, I’m Ubaid Ahmad</p>
          ...
          <div className="grid-container">
            ...
            <div className="space-y-2">
              ...
              <div className="copy-container" onClick={handleCopy}>
                ...
                <p className="lg:text-xl md:text-xl font-medium text-gray_gradient text-white">ubaidahmad2468@gmail.com</p>
              </div>
            </div>
          </div>
        </div>
